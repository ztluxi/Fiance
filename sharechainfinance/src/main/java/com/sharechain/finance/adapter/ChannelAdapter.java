...
public class ChannelAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements OnItemMoveListener {
    ...
    private List<NewsChannelTable> mMyChannelItems, mOtherChannelItems;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(final ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            ...
            case TYPE_MY:
                ...
                myHolder.text_item.setOnLongClickListener(new View.OnLongClickListener() {
                    @Override
...
//        notifyItemMoved(position, mMyChannelItems.size() + COUNT_PRE_OTHER_HEADER);
    ...
    public void onItemMove(int fromPosition, int toPosition) {
        NewsChannelTable item = mMyChannelItems.get(fromPosition - COUNT_PRE_MY_HEADER);
